...
if [ -f "/etc/udev/rules.d/98-omo-r1-mcu.rules" ]; then
    ...
    echo 'SUBSYSTEM=="tty", KERNELS=="3-7", ATTRS{idVendor}=="10c4", ATTRS{idProduct}=="ea60", MODE:="0666", GROUP:="dialout", SYMLINK+="ttyMCU"' > /etc/udev/rules.d/98-omo-r1-mcu.rules
...
if [ -f "/etc/udev/rules.d/98-omo-r1-mcu-1.rules" ]; then
    ...
    echo 'SUBSYSTEM=="tty", KERNELS=="3-7", ATTRS{idVendor}=="10c4", ATTRS{idProduct}=="ea60", MODE:="0666", GROUP:="dialout", SYMLINK+="ttyMotor"' > /etc/udev/rules.d/98-omo-r1-mcu-1.rules
...
if [ -f "/etc/udev/rules.d/97-omo-r1-lidar.rules" ]; then
    ...
    echo 'SUBSYSTEM=="tty", KERNELS=="3-2", ATTRS{idVendor}=="10c4", ATTRS{idProduct}=="ea60", MODE:="0666", GROUP:="dialout",  SYMLINK+="ttyLIDAR"' > /etc/udev/rules.d/97-omo-r1-lidar.rules
...
if [ -f "/etc/udev/rules.d/97-omo-r1-lidar-1.rules" ]; then
    ...
    echo 'SUBSYSTEM=="tty", KERNELS=="3-2", ATTRS{idVendor}=="10c4", ATTRS{idProduct}=="ea60", MODE:="0666", GROUP:="dialout",  SYMLINK+="ttyLiDAR"' > /etc/udev/rules.d/97-omo-r1-lidar-1.rules
